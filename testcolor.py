...
import os
import time
import login_makeMeStrong
import strong_connectivity
...
graphs = __graphlist2('files')
for grap in graphs:
    print(strong_connectivity.is_strong(grap, 1))
    G, edge = login_makeMeStrong.makeMeStrong_(grap)
    print(strong_connectivity.is_strong(G, 0), edge)